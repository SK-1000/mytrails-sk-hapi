...
export const trailService = {
  ...
  async addTrail(id, trail) {
    const response = await axios.post(`${this.trailUrl}/api/traillists/${id}/trails`, trail);
    return response.data;
  },

  async getTrails(id) {
    const response = await axios.get(`${this.trailUrl}/api/traillists/${id}/trails`);
    return response.data;
  },

  async createTraillist(newTraillist) {
    const response = await axios.post(`${this.trailUrl}/api/traillists`, newTraillist);
    return response.data;
  },
};
